...
\NormalTok{mt\_tbl[}
\NormalTok{  (mt\_tbl}\SpecialCharTok{$}\NormalTok{cyl }\SpecialCharTok{==} \DecValTok{6}\NormalTok{) }\SpecialCharTok{\&}
\NormalTok{  (mt\_tbl}\SpecialCharTok{$}\NormalTok{hp }\SpecialCharTok{\textgreater{}} \DecValTok{90}\NormalTok{),}
\NormalTok{]}
\end{Highlighting}
\end{Shaded}
